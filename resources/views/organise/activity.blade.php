        ...
        <div class="row">
            <div class="col-sm-8 col-sm-offset-2">
                <form class="form-horizontal" role="form" method="POST" action="{{ !isset($activity->id) ? route('organise::activity::store') : route('organise::activity::update', ['activity' => $activity->id]) }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="name" class="col-sm-2 col-xs-4 control-label">活動名稱：</label>
                    ...
                    <div class="form-group">
                        <label for="start_time" class="col-sm-2 col-xs-4 control-label">開始時間：</label>
                    ...
                    <div class="form-group">
                        <label for="end_time" class="col-sm-2 col-xs-4 control-label">結束時間：</label>
                    ...
                    <div class="form-group">
                        <label for="venue" class="col-sm-2 col-xs-4 control-label">地點：</label>
                    ...
                    <div class="form-group">
                        <label for="venue_intro" class="col-sm-3 col-xs-4 control-label">地點補充說明：</label>
                    ...
                    <div class="form-group">
                        <label for="summary" class="col-sm-2 col-xs-4 control-label">活動概要：</label>
                    ...
                    <div class="form-group">
                        <label for="apply_start_time" class="col-sm-3 col-xs-4 control-label">報名開始時間：</label>
                    ...
                    <div class="form-group">
                        <label for="apply_end_time" class="col-sm-3 col-xs-4 control-label">報名結束時間：</label>
                    ...
                    <div class="form-group">
                        <label for="apply_fee" class="col-sm-2 col-xs-4 control-label">報名費用：</label>
                    ...
                    <div class="form-group">
                        <label for="intro" class="col-sm-2 col-xs-4 control-label">活動介紹：</label>
                    ...
                    <div class="form-group">
                        @if (isset($activity_banner) && !is_null($activity_banner))
                            <label for="photo" class="col-sm-4 col-xs-4 control-label">
                                更換宣傳圖片：
                            </label>
                        @else
                            <label for="photo" class="col-sm-2 col-xs-4 control-label">
                                宣傳圖片：
                            </label>
                        @endif
                    ...
                    @if (isset($activity_banner) && !is_null($activity_banner))
                        <div class="form-group">
                            <label class="col-sm-3 col-xs-4 control-label">宣傳圖片預覽：</label>
                    ...
                    <div class="form-group">
                        <div class="col-sm-5 col-sm-offset-2 col-xs-5 col-xs-offset-2">
